...
# Class that contains all the different elements that are shown within the
# title of the movie.
class Movies():
    ...
    def __init__(self, title, description, RATINGS,
                 GENRES, director, writter, runtime,
                 cast, review, image_poster, trailer):
